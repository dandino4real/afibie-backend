...
// // ✅ Main setup function
// // Backend: Fix the WebSocket setup function
...
//                         } else {
//                             console.log(`❌ No session found for ${telegramId}`);
//                         }
...
//                 }
//             } catch (err) {
//                 console.error("❌ Invalid WS message or processing error:", err);
//             }
//         });
...
//                     ws.ping();
//                 } catch (error) {
//                     console.error(`❌ Error pinging admin ${adminId}:`, error);
//                 }
//             }
//         });
...
//             } catch (error) {
//                 console.error(`❌ Failed to send admin message to ${telegramId}:`, error);
//             }
//         },
//     };
